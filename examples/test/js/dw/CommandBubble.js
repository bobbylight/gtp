...
CommandBubble.prototype = Object.create(Bubble.prototype, {
   ...
   handleInput: {
      ...
      value: function() {
         ...
         if (im.isKeyDown(InputManager.UP_ARROW, true)) {
         ...
         else if (im.isKeyDown(InputManager.DOWN_ARROW, true)) {
            this.selection = Math.floor((this.selection+1) % 8);
         }
      
         else if (this.selection>3 && im.isKeyDown(InputManager.LEFT_ARROW, true)) {
            this.selection -= 4;
         }
      
         else if (this.selection<4 && im.isKeyDown(InputManager.RIGHT_ARROW, true)) {
            this.selection += 4;
         }
      
         else if (im.isKeyDown(InputManager.X, true)) {
            this.selection = -1;
            return true;
         }
      
         else if (im.isKeyDown(InputManager.Z, true)) {
